...
//  SEXER01
//
//  Created by PROGRAMMING on 07/11/2022.
//  Copyright © 2022 CC-Comprog11. All rights reserved.
//

#include <stdio.h>
int main () {
    int num, thd, h, tn, ons;
    ...
    thd = num/1000;
    if (num >10000){
        printf("Your not following instruction");
    }
    if (num < 10001){
    switch (thd){
    ...
    switch (ons) {
            ...
            case 28:printf(" twenty eighr");break;
            ...
            case 41:printf(" fourty one");break;
            case 42:printf(" fourty two");break;
            case 43:printf(" fourty three");break;
            case 44:printf(" fourty four");break;
            case 45:printf(" fourty five");break;
            case 46:printf(" fourty six");break;
            case 47:printf(" fourty seven");break;
            case 48:printf(" fourty eight");break;
            case 49:printf(" fourty nine");break;
